...
import fwcd.sc18.trainer.core.GameSimulator;
import fwcd.sc18.trainer.core.VirtualClient;

import sc.plugin2018.IGameHandler;
import sc.shared.PlayerColor;

public class GUITrainerApp {
	...
	public GUITrainerApp(String title, int width, int height) {
		...
		Supplier<String> classB = subConfig.addStringOption("Logic B", "fwcd.sc18.geneticneural.GeneticNeuralLogic");
		...
		population = new PopulationPanel(1);
		
		// TODO: Truncate console to limit the buffer
